...
<details>
  <summary>Selecting a Model</summary> 
    ...
    Since the types of predictive analytics models that are considered as the best in data science are the Classification, Clustering, Forecast, Outliers and Time series model (https://www.netsuite.com/portal/resource/articles/financial-management/predictive-modeling.shtml), the decision fell was made between these five model types. Considering the wanted outcome that the model is supposed to predict, the Classification model appeared to be best-fitted for our study (Minaie, 2021).
    More precisely the Random Forest model was selected, which can be used in both regression and classification problems (https://www.section.io/engineering-education/introduction-to-random-forest-in-machine-learning/). However, the Random Forest model was used as a classification model because the problem statement of this study is a classification problem. 
    Furthermore, the decision of using the Random Forest model was based and inspired by studies that dealt with similar matters. For instance, it was used in the study from Byeon (2019) (https://content.iospress.com/articles/technology-and-health-care/thc191738), in which a random forest classifier was developed to predict depression in people, who are caregivers that support patients with the Alzheimer’s Disease, and manage these caregivers’ health. Additionally, another study from Gokten and Uyulan (2021)  (https://www.sciencedirect.com/science/article/abs/pii/S0165032720328500?via%3Dihub) used the Random Forest classifier as a classification model in order to predict the development of depression and post-traumatic stress disorder in sexually abused children. 
    Nevertheless, it was important to have an assurance that the Random Forest model was the right choice of a classification model, for which reason it was compared to several different models. These models were the K-Nearest Neighbors’ (Zhang et al., 2018) (https://ieeexplore.ieee.org/document/7898482), Gradient Boosting (Hubáček et al., 2018) (https://link.springer.com/article/10.1007%2Fs10994-018-5704-6), Decision Tree (Burduk & Wozniak, 2018) (https://www.degruyter.com/document/doi/10.2478/s11536-011-0142-x/html) and the Bagging classifier (Plaia et al., 2021) (https://link.springer.com/article/10.1007%2Fs00357-021-09397-2).
    </p>
</details> 
<details>
